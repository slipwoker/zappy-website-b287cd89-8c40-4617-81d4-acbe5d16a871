    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "מטה מאבק הסיעודיים משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            const response = await fetch('https://api.zappy5.com/api/email/contact-form', {
                ...
                body: JSON.stringify({
                    websiteId: 'b287cd89-8c40-4617-81d4-acbe5d16a871',
                    name: data.name || '',
                    email: data.email || '',
